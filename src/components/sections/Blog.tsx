export default function BlogSection() {
  const blogPosts = [
    {
      image: "https://tse4.mm.bing.net/th/id/OIP.o5MTN9P9DjQC0Dt6vTp5xQHaEJ?rs=1&pid=ImgDetMain&o=7&rm=3",
      date: "August 19, 2025",
      category: "Educación",
  ...
  return (
    <section className="py-16 px-8 relative overflow-hidden max-w-5/6 m-auto">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {blogPosts.map((post, index) => (
            <article
              key={index}
              className="bg-white rounded-2xl overflow-hidden shadow-xl border border-gray-400 transition-colors"
            >
